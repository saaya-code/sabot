...
module.exports = async function (msg) {
   try{
    ...
    if (command.charAt(0)=="*" && command.indexOf("*") == command.lastIndexOf("*") && msg.channel.permissionsFor(msg.guild.me).has("SEND_MESSAGES") && msg.channel.permissionsFor(msg.guild.me).has("ADD_REACTIONS")){
