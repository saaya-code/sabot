...
const p = require("./commands/fun/player")
const commands = {
 ping,select,gif,meme,say,joke,avatar,roaster,quote,help,invite,weather,about,fact,lookfor,rps,motivate,vote,q,like,p
}
